...
class Main(object):
	...
	def LegendGenerate(self):
		...
		Assignmentnode= pydot.Node("Assignment#2 Shoaib Manandhar(26) and Bidhan Rai (38)", shape="none", fontsize="20")
